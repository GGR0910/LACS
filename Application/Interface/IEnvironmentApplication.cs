...
namespace Application.Interface
{
    public interface IEnvironmentApplication : IBaseApplication<Environment>
    {
        ...
        Task<Result<Environment>> Edit(string name, string laboratoryAdress, string laboratoryContactInfo, string laboratoryEmail, string departmentName, string countryName, User loggedUser);
